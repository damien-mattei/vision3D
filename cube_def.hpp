...
// the vertex
Point3Did<float> cubeP1(0.0, 0.0, 0.0);
Point3Did<float> cubeP2(0.0, 0.0, 1.0);
Point3Did<float> cubeP3(0.0, 1.0, 0.0);
Point3Did<float> cubeP4(0.0, 1.0, 1.0);
Point3Did<float> cubeP5(1.0, 0.0, 0.0);
Point3Did<float> cubeP6(1.0, 0.0, 1.0);
Point3Did<float> cubeP7(1.0, 1.0, 0.0);
Point3Did<float> cubeP8(1.0, 1.0, 1.0);

// the list of vertex

#ifdef REF_OR_PTR
list < Point3Did<float> * > vertexCubePtr;
#endif

list < Point3Did<float> > vertexCube;

#ifdef REF_OR_PTR
vertexCubePtr.push_back(&cubeP1);
#endif
...
//Object3D<float> cube(vertexCube,edgeCube);
